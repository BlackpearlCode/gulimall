...
import com.example.coupon.mapper.SkuFullReductionMapper;
...
public class SkuFullReductionServiceImpl implements SkuFullReductionService{
    ...
    public void save(SkuReductionTo skuReductionTo) {
        ...
        List<com.example.coupon.entity.MemberPrice> memberPriceList = memberPrice.stream().map(item -> {
            com.example.coupon.entity.MemberPrice price = new com.example.coupon.entity.MemberPrice();
